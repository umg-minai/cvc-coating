...
zentralen Venekatheter (ZVK) in die Halsvene zu legen
...
Bakterien können an Fremdkörpern, wie ZVKs, haften, von dort über den Blutstrom
...
Blutstrominfektionen ca. 1,4 - 2,8 %, ca. Thrombosen 0,9 - 2,5 % [@Parienti2015; @Bell2018]).
...
In letzter Zeit werden ZVKs zunehmend mit Ultraschall untersucht.
Dabei zeigt sich, dass Blutgerinnsel an den ZVKs viel häufiger sind,
als bisher durch klinische Beobachtung erkannt wurde [@Wu2023; @Gibb2024].

**In dieser Studie soll untersucht werden, ob sich Blutgerinnsel schneller
oder häufiger an ZVKs mit oder ohne antibakterielle Beschichtung entwickeln.**
...
antibakterielle Beschichtung erhalten.
Abgesehen von der zufälligen Zulosung des jeweiligen ZVKs, der bis auf die
mögliche Beschichtung identisch ist, und der täglichen Ultraschalluntersuchung
der Halsvene ändert sich an der medizinisch Behandlung nichts.
Die Ultraschalluntersuchung ist eine äußerliche Anwendung, ungefährlich und schmerzlos.
Jede Untersuchung dauert ca. 10 Minuten und wird von einer\*einem ärztlichen
Kolleg\*in oder wissenschaftlichen Mitarbeiter\*in an Ihrem Bett durchgeführt.
Dabei werden Videos der Halsvene und umliegenden Gewebe aufgenommen.
Beispielhafte Bilder zeigt Abbildung \@ref(fig:ijv-ultrasound-image) (allerdings
hier ohne einliegenden ZVK).


```{r ijv-ultrasound-image, out.width = "100%", fig.cap = "Ultraschallbilder der rechten Seite des Halses. A) Querschnitt der rechten Seite des Halses. Ansicht von den Füßen. Auf der linken Bildseite ist rechts und die rechte Bildseite mittig. Oben legt sich der große Kopfwendermuskel (Musculus sternocleidomastoideus, MSCM) über die innere Halsvene (Vena jugularis interna, VJI), die das Blut aus dem Kopf zum Herzen zurückführt. Der zentrale Venenkatheter wird in diese Vene gelegt (hier nicht abgebildet). Unterhalb der Vene findet sich die Halsschlagader (Arteria carotis communis, ACC). Weiter mittig dann die Luftröhre (Trachea, T). B) Längsschnit der rechten Seite des Halses. Auf der linken Bildseite entspricht kopfwärts und die rechte fußwärts. Auch hier liegt der große Kopfwendermuskel (Musculus sternocleidomastoideus, MSCM) oberhalb der Halsvene (Vena jugularis interna, VJI). Die Halsschlagader und Luftröhre sind in diesem Schnitt nicht zu sehen. ACC: Arteria carotis communis; MSCM: Musculus sternocleidomastoideus; T: Trachea; VJI: Vena jugularis interna.", echo = FALSE}
...
Die Ergebnisse dieser Studie können dazu beitragen, dass für zukünftige Patient\*nnen, die einen ZVK benötigen, die Versorgung verbessert wird.
...
Die Ultraschalluntersuchung ist ein ungefährlich und schmerzfrei.
...
Ihre personenbezogenen Daten werden ausschließlich von den an der Studien beteiligten Mitarbeiter\*innen der Klinik für für Anästhesie, Intensiv-, Notfall- und Schmerzmedizin der Universitätsmedizin Greifswald verarbeitet.
...
- Medikamente (Blutverdünnern, hormonelle Verhütungsmitteln):
- Art Tumorerkrankung.
- Raucherstatus.
- Thrombose in der Vorgeschichte.
- Vorhandensein von Fremdkörpern in Gefäßen (Schrittmacher, Ports, ...).
- Laborwerte, die auf Entzündungsprozeße hinweisen können.
...
Namen, Kontaktinformationen, Geburtsdatum, etc.) verwendet werden, sondern nur ein Nummern- und/oder Buchstabencode.
...
den Nummern- und/oder Buchstabencodes zugeordnet sind.
Diese Liste wird im Studienzentrum gesondert aufbewahrt und unterliegt dort
technischen und organisatorischen Maßnahmen, die gewährleisten, dass Ihre personenenbezogenen
...
unser Auswertung planen wir **alle pseudonymisierten Daten und Bildausschnitte aus den
Ultraschalluntersuchungen im Internet zu veröffentlichen**.

Die Pseudonymisierungsliste wird *nicht* veröffentlicht.
Eine Rückverfolgung Ihrer Daten ist somit für Dritte nicht möglich.

## Dauer, für die die personenbezogenen Daten gespeichert werden

Da wir planen **alle pseudonymisierten Daten und Bildausschnitte aus den
...
Wenn Sie Ihre Einwilligung widerrufen, wer den keine weiteren Daten mehr erhoben.
...
Selbstverständlich steht Ihnen der Prüfarzt jederzeit für Fragen bezüglich der Studie zur Verfügung.
...
Ich willige ein, dass pseudonymisierte Daten und Bilder der
...
**Die nachstehenden Angaben müssen von der\*dem Prüfärzt\*in persönlich ausgefüllt werden:**
